...
- If not, it saves the screenshot to be used as a base in later executions. These images should be reviewed
  manually to ensure there are no unexpected results.
